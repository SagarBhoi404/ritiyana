<!-- resources/views/vendor/puja-kits/show.blade.php -->
    ...
    <div class="mb-8">
        <div class="flex items-center justify-between">
            ...
            <div class="flex items-center space-x-3">
                <a href="{{ route('vendor.puja-kits.edit', $pujaKit) }}" class="inline-flex items-center px-4 py-2 bg-purple-600 border border-transparent rounded-lg text-sm font-medium text-white hover:bg-purple-700">
                        ...
                        @foreach($pujaKit->pujas as $puja)
                            <div class="flex items-start space-x-4 p-4 bg-orange-50 rounded-lg">
                                ...
                                <div class="flex-1">
                                    ...
                                    @endif
                                    <div class="mt-2">
                                        <a href="{{ route('vendor.pujas.show', $puja) }}" class="text-purple-600 text-sm hover:text-purple-700">
                                            View Details →
                                        </a>
                                    </div>
                                </div>
                        ...
                        @foreach($pujaKit->products as $product)
                            <div class="flex items-start space-x-4 p-4 bg-blue-50 rounded-lg">
                                ...
                                <div class="flex-1">
                                    ...
                                    <div class="mt-2">
                                        <a href="{{ route('vendor.products.show', $product) }}" class="text-purple-600 text-sm hover:text-purple-700">
                                            View Product →
                                        </a>
                                    </div>
                                </div>
...
<div class="mt-6 p-6 bg-white border border-gray-200 rounded-lg">
    ...
    <div class="flex items-start space-x-4">
        ...
        <div class="flex-1">
            ...
            <div class="mt-4">
                <a href="{{ route('vendor.vendors.show', $pujaKit->vendor) }}" 
