<!-- resources/views/vendor/puja-kits/index.blade.php -->
    ...
    <div class="mb-8">
        <div class="sm:flex sm:items-center sm:justify-between">
            ...
            <div class="mt-4 sm:mt-0">
                <a href="{{ route('vendor.puja-kits.create') }}" class="inline-flex items-center px-4 py-2 bg-purple-600 border border-transparent rounded-lg text-sm font-medium text-white hover:bg-purple-700">
                    ...
                    <tr class="hover:bg-gray-50">
                        ...
                        <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                            <div class="flex items-center space-x-2">
                                <a href="{{ route('vendor.puja-kits.show', $kit) }}" class="text-blue-600 hover:text-blue-900">
                                    <i data-lucide="eye" class="w-4 h-4"></i>
                                </a>
                                <a href="{{ route('vendor.puja-kits.edit', $kit) }}" class="text-purple-600 hover:text-purple-900">
                                    <i data-lucide="edit" class="w-4 h-4"></i>
                                </a>
                                {{-- <form action="{{ route('vendor.puja-kits.destroy', $kit) }}" method="POST" class="inline" onsubmit="return confirm('Are you sure?')">
                                    @csrf
                                    @method('DELETE')
