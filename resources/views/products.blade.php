        ...
        <div class="grid grid-cols-1 lg:grid-cols-4 gap-8">
            ...
            <div class="lg:col-span-1">
                <div id="mobile-filters"
                    class="lg:block hidden bg-white rounded-2xl border border-gray-200 p-6 lg:sticky lg:top-24 lg:self-start lg:max-h-[calc(100vh-7rem)] lg:overflow-y-auto scrollbar-thin scrollbar-thumb-gray-300 scrollbar-track-gray-100">
                    ...
                    <div class="mb-6">
                        ...
                        <form method="GET" action="{{ route('products.index') }}">
                            ...
                            <button type="submit"
                                class="w-full mt-2 bg-vibrant-pink text-white py-2 rounded-lg text-sm hover:bg-vibrant-pink-dark transition-colors">
                                Search
                            </button>
                        </form>
                    </div>
                        ...
                        <div class="space-y-2">
                            <a href="{{ route('products.index') }}"
                                ...
                                <div class="flex items-center justify-between">
                                    ...
                                    <span
                                        class="text-xs {{ !request('category') ? 'bg-white bg-opacity-20' : 'bg-gray-200' }} px-2 py-1 rounded">
                                        {{ $totalProducts }}
                                    </span>
                                </div>
                            </a>
                            ...
                            @foreach ($categories as $category)
                                <a href="{{ route('products.index', ['category' => $category->slug] + request()->except('category', 'page')) }}"
                                    ...
                                    <div class="flex items-center justify-between">
                                        ...
                                        <span
                                            class="text-xs {{ request('category') == $category->slug ? 'bg-white bg-opacity-20' : 'bg-gray-200' }} px-2 py-1 rounded">
                    ...
                    <div class="mb-6 pt-6 border-t border-gray-200">
                        ...
                        <form method="GET" action="{{ route('products.index') }}">
                            ...
                            <div class="space-y-3">
                                ...
                                <button type="submit"
                                    class="w-full bg-vibrant-pink text-white py-2 rounded-lg text-sm hover:bg-vibrant-pink-dark transition-colors">
                                    Apply Price Filter
                                </button>
                            </div>
                        </form>
            ...
            <div class="lg:col-span-3">
                ...
                <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-6">
                    <p class="text-gray-600">
                        ...
                        @if (request('category'))
                            in
                            <strong>{{ $categories->where('slug', request('category'))->first()?->name ?? 'Category' }}</strong>
                        @endif
                    </p>
                    ...
                    <div class="flex items-center gap-2">
                        ...
                        <form method="GET" action="{{ route('products.index') }}">
                            ...
                            <select name="sort" onchange="this.form.submit()"
                                ...
                                <option value="discount" {{ request('sort') == 'discount' ? 'selected' : '' }}>Highest
                                    Discount</option>
                            </select>
                        </form>
                    </div>
                ...
                @if (request()->hasAny(['search', 'category', 'min_price', 'max_price']))
                    <div class="mb-6 p-4 bg-gray-50 rounded-lg">
                        <div class="flex flex-wrap items-center gap-2">
                            ...
                            @if (request('search'))
                                <span
                                    class="inline-flex items-center gap-1 px-3 py-1 bg-vibrant-pink text-white text-sm rounded-full">
                            ...
                            @if (request('category'))
                                <span
                                    class="inline-flex items-center gap-1 px-3 py-1 bg-blue-500 text-white text-sm rounded-full">
                            ...
                            @if (request('min_price') || request('max_price'))
                                <span
                                    class="inline-flex items-center gap-1 px-3 py-1 bg-green-500 text-white text-sm rounded-full">
                        ...
                        <div class="bg-white rounded-2xl border border-gray-200 overflow-hidden hover:shadow-md transition-shadow cursor-pointer"
                            ...
                            <div class="relative">
                                ...
                                @if ($product->discount_percentage > 0)
                                    <div
                                        class="absolute top-2 left-2 bg-red-500 text-white text-xs font-medium px-2 py-1 rounded">
                                ...
                                @if ($product->manage_stock && $product->stock_quantity <= 5 && $product->stock_quantity > 0)
                                    <div
                                        class="absolute bottom-2 left-2 bg-orange-500 text-white text-xs font-medium px-2 py-1 rounded">
                            ...
                            <div class="p-4">
                                ...
                                <div class="flex items-center gap-2 mb-3">
                                    <span
                                        class="text-lg font-semibold text-vibrant-pink">₹{{ number_format($product->final_price, 2) }}</span>
                        ...
                        <div class="col-span-full text-center py-12">
                            ...
                            <p class="text-gray-500 mb-4">
                                @if (request()->hasAny(['search', 'category', 'min_price', 'max_price']))
                                    ...
                                    <a href="{{ route('products.index') }}"
                                        class="text-vibrant-pink hover:underline">browse all products</a>
                                @else
