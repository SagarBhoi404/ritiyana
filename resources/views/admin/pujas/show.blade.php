    ...
    <div class="mb-8">
        <div class="flex items-center justify-between">
            ...
            <div class="flex items-center space-x-3">
                <a href="{{ route('admin.pujas.edit', $puja) }}" class="inline-flex items-center px-4 py-2 bg-purple-600 border border-transparent rounded-lg text-sm font-medium text-white hover:bg-purple-700">
                ...
                <div class="flex-shrink-0">
                    @if($puja->image)
                        <img class="h-48 w-48 rounded-xl object-cover border-4 border-white shadow-lg" 
                             src="{{ asset('storage/' . $puja->image) }}" 
                             alt="{{ $puja->name }}">
                    @else
                        <div class="h-48 w-48 rounded-xl bg-gradient-to-br from-orange-500 to-red-500 flex items-center justify-center shadow-lg">
                ...
                <div class="flex-1">
                    ...
                    <div class="flex items-center space-x-3 mb-4">
                        <span class="inline-flex px-3 py-1 text-sm font-semibold rounded-full 
                            ...
                            <i data-lucide="{{ $puja->is_active ? 'check-circle' : 'x-circle' }}" class="w-4 h-4 mr-1"></i>
                        ...
                        <div class="space-y-2">
                            @foreach($auspiciousDays as $day)
                                <div class="flex items-center p-3 bg-orange-50 rounded-lg">
                                    ...
                                    <span class="text-gray-900">{{ \Carbon\Carbon::parse($day)->format('F j, Y') }}</span>
                                </div>
                            @endforeach
                        </div>
                    @else
                        ...
                        <div class="border border-gray-200 rounded-lg p-4">
                            <div class="flex items-start justify-between">
                                <div class="flex-1">
                                    ...
                                    <p class="text-sm text-gray-500 mt-1">{{ Str::limit($kit->kit_description, 50) }}</p>
                            ...
                            <div class="mt-4">
                                <a href="{{ route('admin.puja-kits.show', $kit) }}" class="text-purple-600 text-sm hover:text-purple-700">
                                    View Kit Details →
                                </a>
                            </div>
                        </div>
