...
<div class="px-4 sm:px-6 lg:px-8 py-8">
    ...
    <div class="mb-8">
        <div class="flex items-center justify-between">
            ...
            <div class="flex items-center space-x-3">
                <a href="{{ route('admin.products.edit', $product) }}" class="inline-flex items-center px-4 py-2 bg-purple-600 border border-transparent rounded-lg text-sm font-medium text-white hover:bg-purple-700">
                ...
                <div class="flex-shrink-0">
                    @if($product->featured_image)
                        <img class="h-48 w-48 rounded-xl object-cover border-4 border-white shadow-lg" 
                             ...
                             alt="{{ $product->name }}">
                    @else
                        <div class="h-48 w-48 rounded-xl bg-gradient-to-br from-purple-500 to-pink-500 flex items-center justify-center shadow-lg">
                ...
                <div class="flex-1">
                    ...
                    <div class="mb-4">
                        ...
                        @if($product->cost_price)
                            <p class="text-sm text-gray-500 mt-1">Cost: ₹{{ number_format($product->cost_price, 2) }}</p>
                        @endif
                    </div>
                    ...
                    <div class="flex items-center space-x-3 mb-4">
                        <span class="inline-flex px-3 py-1 text-sm font-semibold rounded-full 
                            ...
                            <i data-lucide="{{ $product->is_active ? 'check-circle' : 'x-circle' }}" class="w-4 h-4 mr-1"></i>
                    ...
                    <div class="grid grid-cols-2 md:grid-cols-4 gap-4 text-sm">
                        <div>
                            ...
                            <p class="font-semibold text-lg {{ $product->stock_quantity < 10 ? 'text-red-600' : 'text-green-600' }}">
                                {{ $product->stock_quantity }}
                            </p>
                        </div>
                        <div>
                            <p class="text-gray-500">Stock Status</p>
                            <p class="font-semibold text-lg">{{ ucfirst(str_replace('_', ' ', $product->stock_status)) }}</p>
                        </div>
                        <div>
                            <p class="text-gray-500">Weight</p>
                            <p class="font-semibold text-lg">{{ $product->weight ? $product->weight . ' kg' : 'N/A' }}</p>
                        </div>
                        <div>
                ...
                <div class="p-6">
                    <div class="space-y-4">
                        ...
                        <div class="flex justify-between items-center py-2">
                            ...
                            <span class="text-sm text-gray-900">{{ $product->creator ? $product->creator->full_name : 'N/A' }}</span>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="p-6">
                        @if($product->meta_title)
                            <div class="mb-4">
                                ...
                                <p class="text-gray-900 bg-gray-50 p-3 rounded-lg text-sm">{{ $product->meta_title }}</p>
                            </div>
                        @endif
                        ...
                        @if($product->meta_description)
                            <div>
                                ...
                                <p class="text-gray-900 bg-gray-50 p-3 rounded-lg text-sm">{{ $product->meta_description }}</p>
                            </div>
                        @endif
                    </div>
                </div>
    ...
    <div class="mt-8 flex justify-center space-x-4">
        <a href="{{ route('admin.products.edit', $product) }}" class="inline-flex items-center px-6 py-3 bg-purple-600 border border-transparent rounded-lg text-sm font-medium text-white hover:bg-purple-700 focus:outline-none focus:ring-2 focus:ring-purple-500 focus:ring-offset-2">
            <i data-lucide="edit" class="w-4 h-4 mr-2"></i>
            Edit Product
        </a>
