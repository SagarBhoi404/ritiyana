...
@section('breadcrumb', 'Banners / Edit Banner')
        ...
        <div class="mb-8">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="mt-2 text-sm text-gray-700">Update banner information and settings</p>
                </div>
                            ...
                            <div class="bg-gray-50 rounded-xl p-6">
                                ...
                                <div class="mb-6">
                                    ...
                                    <input type="text" id="alt_text" name="alt_text"
                                        value="{{ old('alt_text', $banner->alt_text) }}" required
                                        class="block w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-purple-500 focus:border-transparent"
